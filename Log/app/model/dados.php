...
class DadoUModel {
    ...
    public function atualizarDado_U($id_dado_u, $nome_pai, $nome_mae, $naturalidade, $uf, $data_nascimento, $deficiente_fisico, $raca_cor, $sexo, $estado_civil, $grau_instrucao){
    ...
    public function excluirDado_U($id_dado_u) {
