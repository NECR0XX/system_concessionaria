...
// Atualiza Frota
if (isset($_POST['id']) && isset($_POST['atualizar_marca_modelo']) && isset($_POST['atualizar_ano_fabricacao']) && isset($_POST['atualizar_placa']) && isset($_POST['atualizar_numero_chassi']) && isset($_POST['atualizar_tipo_veiculo']) && isset($_POST['atualizar_tipo_combustivel']) && isset($_POST['atualizar_quilometragem']) && isset($_POST['atualizar_data_prox_rev']) && isset($_POST['atualizar_historico_manutencao']) && isset($_POST['atualizar_seguro']) && isset($_POST['atualizar_documentacao']) && isset($_POST['atualizar_localizacao_atual']) && isset($_POST['atualizar_responsavel']) && isset($_POST['atualizar_status']) && isset($_POST['atualizar_observacoes'])) {
